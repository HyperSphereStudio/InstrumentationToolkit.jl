...
Pkg.add(url="https://github.com/HyperSphereStudio/libsimplecommunicationencoder_jll")
...
Pkg.add(url="https://github.com/HyperSphereStudio/InstrumentationToolkit.jl")